...
window.I18N['ru-ru'] = {
  ...
  compare: {
    label: 'Сравнение', title: 'По сравнению с другими ORM Python.', col_feature: 'Характеристика',
    ...
    row2: 'Бэкенд автономного использования',
    row3: 'Нет понятия сессии',
    row4: 'Согласованность sync / async API',
    row5: 'Нативная интеграция с Pydantic',
    row6: 'Валидация данных во время выполнения',
    row7: 'Полная выразительность SQL',
    row8: 'Механизм декларации возможностей',
